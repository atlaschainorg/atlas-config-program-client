...
impl<'a> TryFrom<&atlas_program::account_info::AccountInfo<'a>> for Config {
    type Error = std::io::Error;

    fn try_from(
        account_info: &atlas_program::account_info::AccountInfo<'a>,
...
#[cfg(feature = "fetch")]
pub fn fetch_config(
    rpc: &atlas_client::rpc_client::RpcClient,
    address: &atlas_program::pubkey::Pubkey,
...
pub fn fetch_all_config(
    rpc: &atlas_client::rpc_client::RpcClient,
    addresses: &[atlas_program::pubkey::Pubkey],
