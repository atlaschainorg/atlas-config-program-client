...
pub struct Store {
    ...
    pub config_account: (atlas_program::pubkey::Pubkey, bool),
}
...
impl Store {
    ...
    ) -> atlas_program::instruction::Instruction {
    ...
    pub fn instruction_with_remaining_accounts(
        &self,
        args: StoreInstructionArgs,
        remaining_accounts: &[atlas_program::instruction::AccountMeta],
    ) -> atlas_program::instruction::Instruction {
        let mut accounts = Vec::with_capacity(1 + remaining_accounts.len());
        accounts.push(atlas_program::instruction::AccountMeta::new(
        ...
        atlas_program::instruction::Instruction {
            program_id: crate::ATLAS_CONFIG_ID,
            accounts,
            data,
        }
    }
...
pub struct StoreBuilder {
    config_account: Option<(atlas_program::pubkey::Pubkey, bool)>,
    keys: Option<ConfigKeys>,
    data: Option<RemainderVec<u8>>,
    __remaining_accounts: Vec<atlas_program::instruction::AccountMeta>,
}
...
impl StoreBuilder {
    ...
    pub fn config_account(
        &mut self,
        config_account: atlas_program::pubkey::Pubkey,
        as_signer: bool,
    ) -> &mut Self {
    ...
    pub fn add_remaining_account(
        &mut self,
        account: atlas_program::instruction::AccountMeta,
    ) -> &mut Self {
    ...
    pub fn add_remaining_accounts(
        &mut self,
        accounts: &[atlas_program::instruction::AccountMeta],
    ) -> &mut Self {
        self.__remaining_accounts.extend_from_slice(accounts);
        self
    }
    #[allow(clippy::clone_on_copy)]
    pub fn instruction(&self) -> atlas_program::instruction::Instruction {
        let accounts = Store {
...
pub struct StoreCpiAccounts<'a, 'b> {
    ...
    /// Must sign during the first call to `store` to initialize the account,
    /// or if no signers are configured in the config data.
    pub config_account: (&'b atlas_program::account_info::AccountInfo<'a>, bool),
}

/// `store` CPI instruction.
pub struct StoreCpi<'a, 'b> {
    /// The program to invoke.
    pub __program: &'b atlas_program::account_info::AccountInfo<'a>,
    /// The config account to be modified.
    /// Must sign during the first call to `store` to initialize the account,
    /// or if no signers are configured in the config data.
    pub config_account: (&'b atlas_program::account_info::AccountInfo<'a>, bool),
...
impl<'a, 'b> StoreCpi<'a, 'b> {
    pub fn new(
        program: &'b atlas_program::account_info::AccountInfo<'a>,
    ...
    #[inline(always)]
    pub fn invoke(&self) -> atlas_program::entrypoint::ProgramResult {
    ...
    pub fn invoke_with_remaining_accounts(
        &self,
        remaining_accounts: &[(
            &'b atlas_program::account_info::AccountInfo<'a>,
            bool,
            bool,
        )],
    ) -> atlas_program::entrypoint::ProgramResult {
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        remaining_accounts.iter().for_each(|remaining_account| {
            accounts.push(atlas_program::instruction::AccountMeta {
        ...
        let instruction = atlas_program::instruction::Instruction {
            program_id: crate::ATLAS_CONFIG_ID,
            accounts,
            data,
        };
        ...
        if signers_seeds.is_empty() {
            atlas_program::program::invoke(&instruction, &account_infos)
        } else {
            atlas_program::program::invoke_signed(&instruction, &account_infos, signers_seeds)
        }
    }
}
...
impl<'a, 'b> StoreCpiBuilder<'a, 'b> {
    pub fn new(program: &'b atlas_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn config_account(
        &mut self,
        config_account: &'b atlas_program::account_info::AccountInfo<'a>,
        as_signer: bool,
    ) -> &mut Self {
    ...
    pub fn add_remaining_account(
        &mut self,
        account: &'b atlas_program::account_info::AccountInfo<'a>,
        is_writable: bool,
        is_signer: bool,
    ) -> &mut Self {
        self.instruction
...
struct StoreCpiBuilderInstruction<'a, 'b> {
    __program: &'b atlas_program::account_info::AccountInfo<'a>,
    config_account: Option<(&'b atlas_program::account_info::AccountInfo<'a>, bool)>,
    keys: Option<ConfigKeys>,
    data: Option<RemainderVec<u8>>,
